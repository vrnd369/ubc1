...
export default function Footer(){
  ...
  // Handle navigation - just navigate, let ScrollToTop handle scrolling
    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-middle">
          <div className="footer-left-section">
            ...
            <div className="footer-social">
              ...
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="X">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.138 17.52h1.805L7.084 4.126H5.117z" fill="currentColor"/>
                </svg>
              </a>
          ...
          <div className="footer-address-item">
            <h4 className="footer-address-heading">Main Office</h4>
            <p className="footer-address-text">
